              ...
              <div class="form form-horizontal">
                ...
                <fieldset class="fieldset">
                    ...
                    <div class="form-group col-xs-6">
                        ...
                        <div class="col-xs-8">
                            {!!Form::text('code',null,['class'=>'form-control','placeholder'=>'Ingresa el código del alumno', 'required'=>'true', 'id'=>'codeAlumno'])!!}
                        </div>
                    </div>
                    <div class="form-group col-xs-6">
                    ...
                    <div class="form-group col-xs-12">
                        ...
                        <div class="col-xs-8">
                            {!!Form::text('casa',null,['class'=>'form-control','placeholder'=>'Ingresa la dirección del alumno', 'required'=>'true', 'id'=>'direccAlumno'])!!}
                        </div>
                    </div>
                    <div class="row"></div>

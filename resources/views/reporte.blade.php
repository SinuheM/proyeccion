	    		...
	    		<div class="panel panel-default">
					<div class="panel-body">
				    	...
				    	<div class="row" style="margin-bottom: 7px;">
				   		...
				   		<div class="row">
				    		<div class="col-xs-12 reportePanel">
				    			<label for="codigo" class="col-xs-1" style="margin-right: 4%;">Estado:</label>
				    			<div class="col-xs-6 reporteControl">
					    			<div class="col-xs-3"><span class=""><label><input type="checkbox" value="Deudor" name="Deu">Deudor</label></div>
					    			<div class="col-xs-4"><span class=""><label><input type="checkbox" value="No deudor">No deudor</span></div>
					    			<div class="col-xs-4"><span class=""><label><input type="checkbox" value="Observado">Observado</span></div>
					    		</div>						        
				    		</div>
				   		</div>
					</div>
